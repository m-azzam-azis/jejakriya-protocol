          ...
          <div className="bg-gradient-to-r from-primary via-secondary to-accent text-primary-content py-16 px-4 rounded-xl">
            <div className="max-w-7xl mx-auto">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-5xl font-bold" style={{ fontFamily: "'Mileast', sans-serif" }}>
                  JejaKriya Protocol Demo
                </h1>
              </div>
              <p className="text-xl text-primary-content/90 max-w-3xl">
                Fundamental Protocol untuk Aset Kreatif Indonesia - Showcasing Quick Win Features untuk Demo yang
                Impressive
              </p>
            </div>
          </div>
          ...
          {selectedNFT && (
            <section className="card bg-base-100 shadow-xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-start">
                <div>
                  <QRCodeGenerator
                    value={`https://jejakriya.id/verify/${selectedNFT}`}
                    size={300}
                    downloadable={true}
                  />
                </div>
